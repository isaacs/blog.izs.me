---
title: I am not my Autism. Am I? Well drat...
date: 2026-01-28T19:48:55.825Z
slug: i-am-not-my-autism-am-i-well-drat
tags:
  - philosophy
  - the human condition
---
...
> Wrestling with some thoughts, and wanting to hear some
> opinions.
>
> I put a banana inside myself this morning, nothing dirty, I
...
> things inside me that aren't me.
>
> So I've done a bit of stripping, nothing dirty, I just tried to
...
> It's all just the machine I use to interact with the world.
>
> Then I asked; am I my brain? Well, my brain is having all these
...
> in charge, or could choose to be once I realize it.
>
> That brought me to the question I haven't figured out quite
...
> this incredible gift within the right context.
>
> If I am not my autism, then why do I identify with it so
...
I love this. Major topic of speculation, nothing dirty, I just
like looking into my own mind.

> and a lot of that banana will leave me shortly

Just getting the shit talk out of the way early, this is a common
...
But to the point of the post here, I am going to say a lot of
words about this, because I think about it often, and have been
pondering it rigorously, for many decades now.

Let's say you write a program, it's an algorithm that does some
...
program, but on a different computer.

Ok, so is the program the specific bits that make up the program
...
say, sure, the program is the bits, but the program changes.

But what if we then wrote the exact same program, that functioned
...
different specific bits.

So maybe the program isn't the computer _or_ the bits, but the
behavior, the pattern?

And what if it can only run on a single machine that exists, a
...
arbitrary to say where one stops and the other begins.
...
bit is flipped! But it feels like this is even _more_ faithfully
the "same program" than the one before that was re-implemented in
a different language.

Is a "program" even a real thing? And, obviously, this is all a
metaphor to back into the question: Is a "person" even a real
thing? What _is_ it?

Also, what is a "family"? "Capitalism"? "Gender"? All these
things are just convenient analytical tools with no universal
concrete basis in reality.

Of course, when you get down to it, and pursue physics to the
edge, you'll find you can ask the same exact sort of question
about the "hard" things. What _is_ an electron, really? Is it a
...
cheating or solipsism, and is thus fake loser shit.

That means, if we're gonna say _anything_ is "real", including
...
"I'm" real, because the concept of the self predicts behavior
...
things are not in conflict with one another; in fact they _imply_
one another. I'm real because I exist, and the "I" that "exists"
is a model predicting observable behavior.
...
was `4231`? Then you might say "oh, I _thought_ it was the
fibonacci sequence, but it's not _really_, it's something else."
The pattern is "real" if it accurately describes and predicts
observations. If not, then it isn't.

"You" are not your body, "you" are what your body _does_. That's
...
If we went into the computer and changed the program so that it's
